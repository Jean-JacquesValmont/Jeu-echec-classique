			...
			and event.button_index == MOUSE_BUTTON_LEFT and piece_select == my_node_name:
				...
				if piece_protects_against_an_attack == false:
					...
					for f in range(8):
						...
						and (position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "0" or position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "pawn_white"\
						or position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "knight_white" or position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "bishop_white"\
						or position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "rook_white" or position_piece_on_the_chessboard[i+table_move_knight_i[f]][j+table_move_knight_j[f]] == "queen_white"):
...
func preview_move():
	...
	if piece_select == my_node_name and king_in_check == false and piece_protects_against_an_attack == false:
		...
		for f in range(8):
			...
			elif (position_piece_on_the_chessboard[i + table_move_knight_i[f]][j + table_move_knight_j[f]] == "pawn_white"\
			or position_piece_on_the_chessboard[i + table_move_knight_i[f]][j + table_move_knight_j[f]] == "knight_white" or position_piece_on_the_chessboard[i + table_move_knight_i[f]][j + table_move_knight_j[f]] == "bishop_white"\
			or position_piece_on_the_chessboard[i + table_move_knight_i[f]][j + table_move_knight_j[f]] == "rook_white" or position_piece_on_the_chessboard[i + table_move_knight_i[f]][j + table_move_knight_j[f]] == "queen_white"):
